...
<html lang="en">
	...
	<body class="profile">
        ...
        <p class="intro-text">
          25 years ago, in a country, far far east of the world...
        </p>
        <h2 class="main-logo">
        ...
        <div class="main-content">
          <div class="title-content">
            <p class="content-header">EPISODE I <br/>Birth of a Boy</p>

            <br>
            <p class="content-body">
              30 January 1993, a boy was born.
							<a href="portofolio.html">My Portofolio Page</a>
            </p>
          </div>
        </div>
			</div>
		...
		<audio controls id="theme">
  		<source src="audio/new_hope.mp3" type="audio/mpeg" >
