...
def write_source_scripts():
  ...
  doc.line('script', '', src=jquery_link['src'], integrity=jquery_link['integrity'],
           crossorigin=jquery_link['crossorigin'])
  doc.line('script', '', src=popper_link['src'], integrity=popper_link['integrity'],
           crossorigin=popper_link['crossorigin'])
  doc.line('script', '', src=bootstrap_link['src'], integrity=bootstrap_link['integrity'],
           crossorigin=bootstrap_link['crossorigin'])
